...
import 'package:musify/Helpers/config.dart';
import 'package:musify/Helpers/handle_native.dart';
import 'package:musify/Helpers/route_handler.dart';
import 'package:musify/Screens/About/about.dart';
import 'package:musify/Screens/Home/home.dart';
import 'package:musify/Screens/Library/nowplaying.dart';
import 'package:musify/Screens/Library/playlists.dart';
import 'package:musify/Screens/Library/recent.dart';
import 'package:musify/Screens/Login/auth.dart';
import 'package:musify/Screens/Login/pref.dart';
import 'package:musify/Screens/Player/audioplayer.dart';
import 'package:musify/Screens/Settings/setting.dart';
import 'package:musify/Services/audio_service.dart';
import 'package:musify/theme/app_theme.dart';
...
/*
* This MUSIFY app is developed by OM NAI (CE072) & VEDANT PARIKH (CE080)
*/
...
Future<void> startService() async {
  final AudioPlayerHandler audioHandler = await AudioService.init(
    ...
    config: AudioServiceConfig(
      androidNotificationChannelId: 'com.shadow.musify.channel.audio',
...
Future<void> openHiveBox(String boxName, {bool limit = false}) async {
  final box = await Hive.openBox(boxName).onError((error, stackTrace) async {
    ...
    if (Platform.isWindows || Platform.isLinux || Platform.isMacOS) {
      dbFile = File('$dirPath/Musify/$boxName.hive');
      lockFile = File('$dirPath/Musify/$boxName.lock');
    }
    await dbFile.delete();
