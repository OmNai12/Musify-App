...
import 'package:musify/Helpers/picker.dart';
import 'package:musify/Helpers/supabase.dart';
import 'package:musify/Screens/Home/saavn.dart' as home_screen;
import 'package:musify/Screens/Settings/player_gradient.dart';
...
class _SettingPageState extends State<SettingPage> {
  ...
  String autoBackPath = Hive.box('settings').get(
    'autoBackPath',
    defaultValue: '/storage/emulated/0/Musify/Backups',
  ) as String;
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              TextButton(
                                                style: TextButton.styleFrom(//.secondary,
                                                ),
                                                onPressed: () {
                                                  Navigator.pop(context);
                                                },
